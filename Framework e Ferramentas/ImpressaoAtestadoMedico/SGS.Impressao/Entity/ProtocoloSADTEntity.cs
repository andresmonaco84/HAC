...
{
    [Serializable()]
    public class ProtocoloSADTEntity : Entity
    {
        public ProtocoloSADTEntity()
        {
        ...
        private string strLote = string.Empty;
        private string strSequenciaDigitacao = string.Empty;
        private string strQuarto = string.Empty;
        private string strLeito = string.Empty;
        private string strSetorQuartoLeito = string.Empty;
        ...
        public string SequenciaDigitacao
        {
            set { strSequenciaDigitacao = value; }
            get { return strSequenciaDigitacao; }
        }

        public string Quarto
        {
            set { strQuarto = value; }
            get { return strQuarto; }
        }
        ...
        public string SetorQuartoLeito
        {
            set { strSetorQuartoLeito = value; }
            get { return strSetorQuartoLeito; }
        }
