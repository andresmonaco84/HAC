create or replace procedure PRC_INT_REL_HISTORICO
  (
...
pCAD_CGC_ID_E IN TB_CAD_CNV_CONVENIO.CAD_CGC_ID%TYPE DEFAULT NULL,
  ...
  /********************************************************************
  *    Procedure: PRC_INT_REL_HISTORICO
  *
  *    Data Criacao:  03/11/2010      Por: Pedro
  *    Data Alteracao:  23/11/2010         Por: PEDRO
  *    Alterac?o:     SELECT MAX(IML3.ATD_IML_ID) , fnc_cad_pes_municipio_s e  ATD_IML_DT_ENTRADA
  *    Data Alteracao:04/11/2011   Por:Eduardo Hyppolito
  *
  *    Altera??o: Campo Instituto Geriatria (LEFT JOIN BENEFICIARIO)
...
begin
  OPEN v_cursor FOR
SELECT DISTINCT
                ATD.ATD_ATE_DT_ATENDIMENTO ATD_IML_DT_ENTRADA,
               ATD.ATD_ATE_HR_ATENDIMENTO ATD_IML_HR_ENTRADA,
         ...
         --      PES_UNI.CAD_PES_NM_PESSOA UNIDADE,
               ...
               PES.CAD_PES_TP_SEXO,
               fnc_cad_pes_municipio_s(PAC.CAD_PES_ID_PESSOA,1) AUX_MUN_NM_MUNICIPIO,
...
/*LEFT JOIN          (SELECT IML.ATD_ATE_ID,IML.CAD_CAD_QLE_ID
                FROM TB_ATD_IML_INT_MOV_LEITO IML
                JOIN ( SELECT IML.ATD_ATE_ID, min(FNC_JUNTAR_DATA_HORA(IML.ATD_IML_DT_ENTRADA,IML.ATD_IML_HR_ENTRADA)) data
                      FROM TB_ATD_IML_INT_MOV_LEITO  IML
                ...
                ) A ON A.ATD_ATE_ID = IML.ATD_ATE_ID
                AND A.DATA = (FNC_JUNTAR_DATA_HORA(IML.ATD_IML_DT_ENTRADA,IML.ATD_IML_HR_ENTRADA))
                ) IML
