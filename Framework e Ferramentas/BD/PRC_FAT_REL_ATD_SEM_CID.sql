CREATE OR REPLACE PROCEDURE "PRC_FAT_REL_ATD_SEM_CID"
(
...
IS
/********************************************************************
*    PROCEDURE: PRC_FAT_REL_ATD_SEM_CID
*    DATA ALTERACAO: 25/4/2011  POR: PEDRO
*    ALTERAC?O: 
*******************************************************************/
  ...
  begin
   ...
   '
    SELECT DISTINCT
            ...
            CASE WHEN CCI.FAT_CCI_ID IS NOT NULL THEN '||chr(39)||'S'||chr(39)||'
                 ELSE '||chr(39)||'N'||chr(39)||'
            END DIGITADO
    ...
    LEFT JOIN TB_FAT_CCI_CONTA_CONSU_ITEM CCI    ON    CCI.ATD_ATE_ID            = ATE.ATD_ATE_ID
                                                 AND   CCI.FAT_CCI_FL_STATUS = '||chr(39)||'A'||chr(39)||'
     WHERE   ATE.ATD_ATE_ID NOT IN
    (
            SELECT  CCP.ATD_ATE_ID
            FROM    TB_FAT_CCP_CONTA_CONS_PARC CCP
            WHERE   CCP.ATD_ATE_ID = ATE.ATD_ATE_ID and ccP.fat_ccP_fl_status = '||chr(39)||'A'||chr(39)||'
    )
   AND    ATE.CAD_CID_CD_CID10 IS NULL
