create or replace procedure PRC_INT_REL_TERMO_ACOMOD_DIF
  (
  ...
  is
  /********************************************************************
  *    Procedure: PRC_INT_REL_TERMO_ACOMOD_DIF
  *
  *    Data Criacao:   03/08/09   Por: Pedro
...
WHERE (IAE.ATD_IAE_ID = pATD_ATE_ID)    ;
    io_cursor := v_cursor;
  end PRC_INT_REL_TERMO_ACOMOD_DIF;
