CREATE OR REPLACE PROCEDURE PRC_REP_IMP_PRODUTIVIDADE_P9(pFAT_CCI_DT_INICIO_CONSUMO_INI IN TB_FAT_CCI_CONTA_CONSU_ITEM.FAT_CCI_DT_INICIO_CONSUMO%TYPE,
...
BEGIN
    ...
    CURSOR FAT IS
      SELECT DISTINCT ATD.ATD_ATE_ID,
       ...
       WHERE CCI.FAT_CCI_CD_CLINICA_PROF IN
         ...
         AND ATD.CAD_LAT_ID_LOCAL_ATENDIMENTO IS NULL
  ...
  BEGIN
    ...
    END LOOP; COMMIT;
  END ;
  END PRC_REP_IMP_PRODUTIVIDADE_P9;
/
