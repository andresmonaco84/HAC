CREATE OR REPLACE PROCEDURE PRC_REP_IMP_PRODUTIVIDADE_P5(pFAT_CCI_DT_INICIO_CONSUMO_INI IN TB_FAT_CCI_CONTA_CONSU_ITEM.FAT_CCI_DT_INICIO_CONSUMO%TYPE,
...
BEGIN
  ...
  DECLARE
    CURSOR FAT IS
      SELECT DISTINCT ATD.ATD_ATE_ID,
       ...
       WHERE /*
             CCI.FAT_CCI_CD_CLINICA_PROF IN
  ...
  BEGIN
    ...
    END LOOP; COMMIT;
  END ;
  END PRC_REP_IMP_PRODUTIVIDADE_P5;
/
