create or replace procedure PRC_CAD_IPA_ITM_PCT_PRD_L
(
...
WHERE
     ...
     AND FNC_VALIDAR_VIGENCIA_DATA(IPA.CAD_IPA_DT_INICIO_VIGENCIA, IPA.CAD_IPA_DT_FIM_VIGENCIA, pDATACONSUMO) = 1
     AND IPA.CAD_PRD_ID_PACOTE = pCAD_PRD_ID_PACOTE;
io_cursor := v_cursor;
end PRC_CAD_IPA_ITM_PCT_PRD_L;
