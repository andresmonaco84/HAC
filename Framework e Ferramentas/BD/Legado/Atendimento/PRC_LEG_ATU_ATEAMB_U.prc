...
create or replace procedure PRC_LEG_ATU_ATEAMB_U
(
...
is
  /********************************************************************
  *    Procedure: PRC_LEG_ATU_ATEAMB_U
  *
  *    Data Criacao:  11/01/2008   Por: SILMARA
  *    Data Alteracao 29/02/2008   Por Silmara
  ...
  *    Alteracao: Atendimento de consulta
  ...
  *    Funcao: alterar as informações na tabela paciente_atendimento_amb
  *
  *******************************************************************/
