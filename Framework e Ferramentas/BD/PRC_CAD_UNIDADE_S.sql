CREATE OR REPLACE PROCEDURE PRC_CAD_UNIDADE_S
  (
  ...
  is
  /********************************************************************
  *    Procedure: PRC__CAD_UNI_UNIDADE_S
  *
  *    Data Criacao: 	data da  criação   Por: Nome do Analista
  *    Data Alteracao:	04/08/2010  Por: Rafael Coimbra
  *    Data Alteracao:	15/10/2010  Por: André Souza Monaco
  *         Alteração:  Adição do param. pCAD_UNI_FL_FATURA_UNID_OK
  *
  *    Funcao: Seleciona unidades
  *
  *******************************************************************/
  ...
  begin
    ...
    SELECT
       ...
       CAD_UNI_ID_UNIDADE_MASTER_AMIL
    ...
    WHERE
        ...
        (pCAD_UNI_FL_FATURA_UNID_OK is null OR CAD_UNI_FL_FATURA_UNID_OK = pCAD_UNI_FL_FATURA_UNID_OK) AND
        (pCAD_UNI_DS_UNIDADE is null OR CAD_UNI_DS_UNIDADE = pCAD_UNI_DS_UNIDADE)
       ORDER BY CAD_UNI_DS_UNIDADE;
    io_cursor := v_cursor;
  end PRC_CAD_UNIDADE_S;
