CREATE OR REPLACE PROCEDURE PRC_REP_IMP_PRODUTIVIDADE_P1(pFAT_CCI_DT_INICIO_CONSUMO_INI IN TB_FAT_CCI_CONTA_CONSU_ITEM.FAT_CCI_DT_INICIO_CONSUMO%TYPE,
                                                         ...
                                                         pFAT_CCI_CD_CLINICA_PROF      IN VARCHAR2
                                                         ) IS
...
*/
         ...
         AND TRUNC(CCI.FAT_CCI_DT_INICIO_CONSUMO) BETWEEN TO_DATE(pFAT_CCI_DT_INICIO_CONSUMO_INI,'DD/MM/YYYY') AND
             TO_DATE(pFAT_CCI_DT_INICIO_CONSUMO_FIM,'DD/MM/YYYY')
  ...
  BEGIN
    ...
    END LOOP; COMMIT;
  END ;
  END PRC_REP_IMP_PRODUTIVIDADE_P1;
/
