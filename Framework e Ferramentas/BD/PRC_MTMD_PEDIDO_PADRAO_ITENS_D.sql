CREATE OR REPLACE PROCEDURE PRC_MTMD_PEDIDO_PADRAO_ITENS_D
  (
  ...
  is
  /********************************************************************
  *    Procedure: PRC_MTMD_PEDIDO_PADRAO_ITENS_D
  *
  ...
  begin
     ...
     BEGIN
       ...
       INTO  vCAD_LAT_ID_LOCAL_ATENDIMENTO,
             ...
             vCAD_SET_ID,
             vCAD_MTMD_FILIAL_ID
       FROM SGS.TB_MTMD_PEDIDO_PADRAO        PEDIDO
       WHERE PEDIDO.mtmd_pedpad_ID = pMTMD_PEDPAD_ID;
       -- ATUALIZA ESTOQUE UNIDADE
       UPDATE SGS.TB_MTMD_ESTOQUE_LOCAL SET
       MTMD_PEDPAD_QTDE = NULL
    ...
    DELETE TB_MTMD_PEDIDO_PADRAO_ITENS
    WHERE
        CAD_MTMD_ID = pCAD_MTMD_ID
    AND MTMD_PEDPAD_ID = pMTMD_PEDPAD_ID;
  end PRC_MTMD_PEDIDO_PADRAO_ITENS_D;
