CREATE OR REPLACE FUNCTION "FNC_COB_VL_RETENCAO"
(
...
---retorna O VALOR NFO_VL_RETENCAO
return NUMBER is Result NUMBER;
begin

SELECT DISTINCT SUM(NOF.FAT_NFO_VL_RETENCAO) OVER (PARTITION BY CASE WHEN pCAD_CNV_ID_CONVENIO IS NOT NULL THEN NOF.CAD_CNV_ID_CONVENIO ELSE NULL END) INTO RESULT
