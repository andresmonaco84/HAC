 CREATE OR REPLACE FUNCTION "FNC_COB_VL_DESCONTO"
(
...
SELECT DISTINCT SUM(NOF.FAT_NOF_VL_DESCONTO) OVER (PARTITION BY CASE WHEN pCAD_CNV_ID_CONVENIO IS NOT NULL THEN NOF.CAD_CNV_ID_CONVENIO ELSE NULL END) INTO RESULT
