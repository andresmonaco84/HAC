create or replace procedure PRC_CAD_PRD_PRODUTO_R_COD
(     
...
is
/********************************************************************
*    Procedure: PRC_CAD_PRD_PRODUTO_R_COD
* 
*    Data Criacao: 22/09/2010   Por: André Souza Monaco
*
*    Funcao: Seleciona registro pela tabela e pelo codigo (com LIKE)
*
*******************************************************************/
...
WHERE   CAD_PRD_CD_CODIGO LIKE pCAD_PRD_CD_CODIGO
    AND TIS_MED_CD_TABELAMEDICA = pTIS_MED_CD_TABELAMEDICA;          
io_cursor := v_cursor;
end PRC_CAD_PRD_PRODUTO_R_COD;
