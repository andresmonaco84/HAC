CREATE OR REPLACE PROCEDURE PRC_REP_IMP_PRODUTIVIDADE_P3(pFAT_CCI_DT_INICIO_CONSUMO_INI IN TB_FAT_CCI_CONTA_CONSU_ITEM.FAT_CCI_DT_INICIO_CONSUMO%TYPE,
...
BEGIN
  ...
  BEGIN
    ...
    END LOOP; COMMIT;
  END ;
  END PRC_REP_IMP_PRODUTIVIDADE_P3;
/
