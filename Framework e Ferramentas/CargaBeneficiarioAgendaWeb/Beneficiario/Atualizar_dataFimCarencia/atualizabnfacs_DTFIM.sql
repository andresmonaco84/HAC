...
SPOOL F:\AgendaWeb\Beneficiario\Atualizar_dataFimCarenciaATUALIZADADOSBNFACS_DTFIM.SQL
...
'('|| CHR(39) || ('SD01')||CHR(39)||','|| CHR(39)||bnf.codcon|| CHR(39)||','||bnf.codest||','||bnf.codben||','
 ...
 CHR(39)||to_char(SYSDATE,'yyyy-dd-mm')||CHR(39)||','|| 
...
||' )'
   ...
   BNF_CARENCIA_BENEFICIARIO  bcb
     ...
     and (bcb.CODSER = 4 and bcb.DATFIMCAR > TRUNC(SYSDATE - 1))
