<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelatorioPaciente.aspx.cs"
...
<body>
    <form id="form1" runat="server">
        <div>
                                ...
                                <tr>
                                    <td>
                                        <table style="font-family: Arial; font-size: 12pt;" id="Table2" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="font-size: 10pt">Matrícula:</span></td>
                                                <td>
                        ...
                        <asp:Panel ID="pnlGrid" runat="server">
                            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" BorderColor="Silver"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="VALOR_TOTAL" Visible="False" DataFormatString="{0:N}"
            ...
            <asp:Panel ID="pnlTotal" Visible="false" Width="640px" runat="server" HorizontalAlign="Right">
