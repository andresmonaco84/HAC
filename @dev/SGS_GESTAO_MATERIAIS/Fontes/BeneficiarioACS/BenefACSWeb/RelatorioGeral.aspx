<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelatorioGeral.aspx.cs" Inherits="RelatorioGeral" %>
                        ...
                        <asp:Panel ID="pnlGrid" runat="server">
                            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" BorderColor="Silver"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CAD_MTMD_UNID_COMPRA_DS" Visible="False" HeaderText="Unidade">
