<%@ Page Language="C#" AutoEventWireup="True" Codebehind="RelatorioGeral.aspx.cs" Inherits="RelatorioGeral" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                            ...
                            <table id="Table1" style="font-family: Arial; font-size: 12pt;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <strong><span style="font-family: Arial; font-size: 12pt;">Fornecimento de Medicamentos
                                            e Materiais para Intern. Domiciliar</span> </strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" BorderColor="Silver"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="MTMD_MOV_DATA" DataFormatString="{0:dd/MM/yyyy HH:mm}"
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="90px" Font-Size="Smaller" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CAD_MTMD_NOMEFANTASIA" HeaderText="Descri&#231;&#227;o Mat/Med">
                                        <ItemStyle HorizontalAlign="Left" Width="150px" Font-Size="Smaller" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MTMD_MOV_QTDE" HeaderText="Qtd.">
                                        <ItemStyle HorizontalAlign="Center" Width="40px" Font-Size="Smaller" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CAD_MTMD_UNID_VENDA_DS" Visible="False" HeaderText="Unidade">
                                        <ItemStyle HorizontalAlign="Center" Width="70px" Font-Size="Smaller" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="VALOR_UNITARIO" Visible="False" DataFormatString="{0:N}"
                                        HeaderText="Valor Unit&#225;rio (R$)">
                                        <ItemStyle HorizontalAlign="Right" Width="75px" Font-Size="Smaller" />
                                    </asp:BoundField>
            ...
            <asp:Panel ID="pnlTotal" Width="640px" runat="server" HorizontalAlign="Right" Visible="false">
