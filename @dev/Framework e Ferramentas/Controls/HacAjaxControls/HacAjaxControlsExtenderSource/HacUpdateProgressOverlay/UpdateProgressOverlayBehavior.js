 ...
 */
Type.registerNamespace('Hac');

Hac.UpdateProgressOverlayBehavior = function (element) {
    Hac.UpdateProgressOverlayBehavior.initializeBase(this, [element]);
...
Hac.UpdateProgressOverlayBehavior.prototype = {
    initialize : function() {
        Hac.UpdateProgressOverlayBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose : function() {
        ...
        Hac.UpdateProgressOverlayBehavior.callBaseMethod(this, 'dispose');
    },
    //
    // Handlers
    //
...
Hac.UpdateProgressOverlayBehavior.registerClass('Hac.UpdateProgressOverlayBehavior', Sys.UI.Behavior);