...
namespace Hac.Windows.Forms.Controls
{
    public partial class HacToolStrip : ToolStrip
    {
        ...
        public string ToolTipSalvar
        {
            get { return btnSalvar.ToolTipText; }
            set { btnSalvar.ToolTipText = value; }
        }
        [Category("Hac")]
        [Description("Define mensagem do campo salvar")]
        public string SalvarText
        {
            get { return btnSalvar.Text; }
            set { btnSalvar.Text = value; }
        }
        [Category("Hac")]
        [Description("Define o tamanho do text do campo salvar")]
        public int SalvarTextTamanho
        {
            get { return btnSalvar.Width; }
        ...
        [Category("Hac")]
        [Description("Define estado do campo Adicionar (Habilitado/Desabilitado)")]
        public bool SalvarHabilitado
        {
            get { return btnSalvar.Enabled; }
            set { btnSalvar.Enabled = value; }
        }       
        #endregion
        ...
        [Category("Hac")]
        public event AfterBeforeHacEventHandler BeforeLimpar;
        [Category("Hac")]
        ...
        protected virtual void OnBeforeLimpar()
        {
            if (BeforeLimpar != null) BeforeLimpar(this);
        }
        ...
        private void tsBtnLimpar_Click(object sender, EventArgs e)
        {
            ...
            System.Windows.Forms.Cursor.Current = Cursors.WaitCursor;
            if (BeforeLimpar != null) OnBeforeLimpar();

            if (((FrmBase)this.FindForm()).ValidaObjeto(Evento.eLimpar))
            {
                if (LimparClick != null)
                {
                    if (this.LimparClick(sender))
                    {
                        ControlaBotoes(Evento.eLimpar);
                        if (AfterLimpar != null) OnAfterLimpar();
                    }
                }
                else
