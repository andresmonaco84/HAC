...
namespace Hac.Windows.Forms.Controls.Forms
{
    ...
    {
        public FrmWeb(string url, string title, int width, int height, bool hideMenu)
        {
            InitializeComponent();
            ...
            this.panelHideMenu.Visible = hideMenu;
        ...
        //{
        //    var popup = new FrmWebPopup(this.Width,this.Height);
        //    popup.Show(this);
        //    ppDisp = popup.Browser;
        //}
