...
namespace Hac.Windows.Forms.Controls.Forms
{
	...
	/// </summary>
    //[System.Drawing.ToolboxBitmap(typeof(WebCamCapture), "ImagensCAMERA.ICO")] // toolbox bitmap
	...
	public class WebCamCapture : System.Windows.Forms.UserControl
	{
		...
		*/
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			...
			{
                if (excep.Message == "Referência de objeto não definida para uma instância de um objeto.")
                {
