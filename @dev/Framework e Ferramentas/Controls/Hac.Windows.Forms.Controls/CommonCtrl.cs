    ...
    public class CommonCtrl
    {
        ...
        public static void ValidaObjeto(Evento e, Control controle)
        {
            ...
            if (controle is IHacRequiredControl)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(Mensagem)) throw new  HacRequiredFieldException(Mensagem);
                }
            }
        }
        ...
        /// <summary>
        /// Verifica se a hora é valida, verificando se o valor digitado fica abaixo de 23:59
        /// </summary>
        public static bool ValidarHora(string hora, string minuto)
        {
            int horaMaximaPermitida = 23;
            int minutoMaximoPermitido = 59;

            if (Convert.ToInt32(hora) > horaMaximaPermitida || Convert.ToInt32(minuto) > minutoMaximoPermitido)
            {
                throw new HacException("A Hora digitada é inválida.");
            }
