...
{     
    public partial class HacCmbEspecialidadeProcedimento : HacComboBox
    {
        ...
        public HacCmbEspecialidadeProcedimento()
        {
            InitializeComponent();
        }
        ...
        public HacCmbEspecialidadeProcedimento(IContainer container)
        {
            container.Add(this);
        ...
        public void CarregaEspecialidadeProcedimento(bool adicionarIdtDescricao, DataTable dtbEspecialidadeProcedimento)
        {
            ...
            if (dtbEspecialidadeProcedimento == null)
            {
                ...
                {
                    dtbEspecialidadeProcedimento = EspecialidadeProcedimento.ListarJoinProduto(especialidadeProcedimentoDTO, TipoAtributo, CodigoTabelaMedica);
                }
                else
                {
