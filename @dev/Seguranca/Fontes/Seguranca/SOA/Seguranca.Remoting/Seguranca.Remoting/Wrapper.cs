...
namespace HospitalAnaCosta.SGS.Seguranca.Remoting
{
    public class Wrapper : HospitalAnaCosta.Framework.Communication.Remoting.Server
    {
        ...
        private new void Configure()
        {
            ...
            int porta = int.Parse(ConfigurationManager.AppSettings["HAC.REMOTING.SGS.SEGURANCA.PORT"]);
            ...
            base.AssemblyToLoad.Add("SGS.Seguranca", "Seguranca.Control");
            Logar("Carregando Assembly 'Seguranca.Control'");
            // adicionando os namespaces que devem ser expostos
            base.NamespaceExpose.Add("Seguranca.Control", "HospitalAnaCosta.SGS.Seguranca.Control");
