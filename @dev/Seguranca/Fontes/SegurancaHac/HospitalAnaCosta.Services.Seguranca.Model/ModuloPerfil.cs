...
namespace HospitalAnaCosta.Services.Seguranca.Model
{
	...
	{			
		...
		{            
			...
			string query = "PRC_SEG_MPF_MODULO_PERFIL_R_L";
		...
		{            
			...
			ModuloPerfilDataTable result = new ModuloPerfilDataTable();
			string query = "PRC_SEG_MPF_MODULO_PERFIL_R_S";
		...
		public void Excluir(ModuloPerfilDTO dto)
		{
			...
			string query = "PRC_SEG_MPF_MODULO_PERFIL_R_D";
		...
		{			
			string query = "PRC_SEG_MPF_MODULO_PERFIL_R_I";
